...
//                String type2 = GsonHelper.getAsString(jsonobject2, "type");
        ...
        public static int getStageFromString(String s) {
            return switch (s) {
                ...
                case "all" -> case "all" -> VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT; //VK_SHADER_STAGE_ALL_GRAPHICS includes tessellation/geometry stages, which are unused;
